...
*/   
         if(tiempoDeVideo > 40) {
          ...
          if(tiempoDeVideo > 124) {
            ...
            a6.style.color = '#696b3a';
            a6.style.fontSize = '115%'; 
            a6.style.textDecoration = 'underline'; 
            } 
          ...
          a6.style.textDecoration = 'none';           //7
          a6.style.fontSize = '100%'; 
          a6.style.color = 'black'; 
          a7.style.fontSize = '115%'; 
          a7.style.color = '#696b3a';
          }
