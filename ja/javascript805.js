...
var scrollImage = document.getElementById('scrollImage');
 ...
 function colorText() {
  ...
  if(tiempoDeVideo > 13) {
    a000.style.transition = 'font-size 0.3s ease';
    a000.style.color = 'white';  
  ...
  if(tiempoDeVideo > 97) {
    ...
    a12.style.transition = 'font-size 0.5s ease';
  }
