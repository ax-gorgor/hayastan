...
function onYouTubeIframeAPIReady() {
 ...
 function colorText() {
  ...
  if(tiempoDeVideo > 5.5) {
    a1.style.color = '#2d6520'; //rojo    //1
  ...
  if(tiempoDeVideo > 66) {
    ...
    a12.style.color = '#2d6520'; 
    a12.style.fontSize = '115%'; 
  } 
  
  if(tiempoDeVideo > 71.5) {
