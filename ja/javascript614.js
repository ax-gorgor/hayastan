     ...
     if(tiempoDeVideo > 11) {
        a0.style.color = 'white';
         ...
         if(tiempoDeVideo > 115.5) {
          ...
          a7.style.color = '#800c06';
          a6.style.fontSize = '100%'; 
          a7.style.fontSize = '115%'; 
          }

          if(tiempoDeVideo > 182.5) {
            a7.style.color = 'black';           //3
            a8.style.color = '#800c06';
